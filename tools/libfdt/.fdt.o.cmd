cmd_tools/libfdt/fdt.o := /usr/bin/gcc -O2 -isystem /home/avi/Buildroot-2/buildroot/output/host/include -Wp,-MD,tools/libfdt/.fdt.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/libfdt/fdt.o tools/libfdt/fdt.c
